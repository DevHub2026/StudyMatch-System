...
**Run Flutter from this folder only** (the project root):

`C:\Project\StudyMatch-System\studymatch-mobile`

Do **not** use `studymatch-mobile\studymatch-mobile` — that was a duplicate nested copy. All recent fixes (drawer navigation, dashboard layout, Laravel API) live in the parent folder above.

```bash
cd C:\Project\StudyMatch-System\studymatch-mobile
